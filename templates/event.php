...
<div class="background">
  <div class="container">
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="event_overview">
              <p><i class="fa fa-calendar-o" aria-hidden="true"></i>Date</p>
              <p class="info"><?php the_field('event_date'); ?></p>
              <p><i class="fa fa-clock-o" aria-hidden="true"></i>Time</p>
              <p class="info"><?php the_field('event_time'); ?></p>
              <?php $address = get_field('event_address');
                if( !empty($address) ):
                ?>
              <p><i class="fa fa-map-marker" aria-hidden="true"></i><?php the_field('event_location'); ?></p>
              <p class="info"><?php echo $address['address']; ?></p>
      ...
      <div class="col-lg-3 container_spacing_bottom">
        <div class="upcoming_wrapper">
        <h4 class="upcoming_events">Upcoming Events</h4>
          <?php
          ...
          <?php if ( $upcomingquery->have_posts() ) :
